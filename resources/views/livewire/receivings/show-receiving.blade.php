        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">RECEIVING ITEMS</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" wire:click="NewReceivingItemModalClose"></button>
            </div>
            <div class="modal-body">
                @livewire('forms.form-receiving-item')
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" wire:click="NewReceivingItemModalClose">Close</button>
            </div>
        </div>
    </div>
</div>
